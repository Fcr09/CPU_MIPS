...
module alu_controller( F12,
    ...
    ***************************************************************************/
   assign s_LOGISIM_NET_29                   = F30;
   assign s_LOGISIM_NET_8                    = OP4;
   assign s_LOGISIM_NET_3                    = OP5;
   assign s_LOGISIM_NET_0                    = OP3;
   assign s_LOGISIM_NET_24                   = OP6;
   assign s_LOGISIM_NET_13                   = OP2;
   assign s_LOGISIM_NET_2                    = F13;
   assign s_LOGISIM_NET_11                   = F25;
   assign s_LOGISIM_NET_7                    = F14;
   assign s_LOGISIM_NET_25                   = F12;

   /***************************************************************************
    ** Here all output connections are defined                               **
    ***************************************************************************/
   assign S0                                 = s_LOGISIM_NET_219;
   assign S3                                 = s_LOGISIM_NET_161;
   assign S1                                 = s_LOGISIM_NET_253;
   assign S2                                 = s_LOGISIM_NET_206;

   /***************************************************************************
    ** Here all normal components are defined                                **
    ***************************************************************************/
   NOT_GATE      GATE_1 (.Input_1(s_LOGISIM_NET_13),
                         .Result(s_LOGISIM_NET_187));

   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_2 (.Input_1(s_LOGISIM_NET_233),
              .Input_2(s_LOGISIM_NET_2),
              .Input_3(s_LOGISIM_NET_210),
   ...
   NOT_GATE      GATE_7 (.Input_1(s_LOGISIM_NET_25),
                         .Result(s_LOGISIM_NET_270));

   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_8 (.Input_1(s_LOGISIM_NET_43),
              .Input_2(s_LOGISIM_NET_2),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_14 (.Input_1(s_LOGISIM_NET_7),
               .Input_2(s_LOGISIM_NET_2),
   ...
   NOT_GATE      GATE_17 (.Input_1(s_LOGISIM_NET_25),
                          .Result(s_LOGISIM_NET_134));

   NOT_GATE      GATE_18 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_267));

   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_19 (.Input_1(s_LOGISIM_NET_117),
               .Input_2(s_LOGISIM_NET_2),
   ...
   NOT_GATE      GATE_20 (.Input_1(s_LOGISIM_NET_0),
                          .Result(s_LOGISIM_NET_204));

   NOT_GATE      GATE_21 (.Input_1(s_LOGISIM_NET_0),
                          .Result(s_LOGISIM_NET_227));

   NOT_GATE      GATE_22 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_179));

   NOT_GATE      GATE_23 (.Input_1(s_LOGISIM_NET_3),
                          .Result(s_LOGISIM_NET_124));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_24 (.Input_1(s_LOGISIM_NET_29),
               .Input_10(s_LOGISIM_NET_95),
               .Input_2(s_LOGISIM_NET_141),
               .Input_3(s_LOGISIM_NET_186),
               .Input_4(s_LOGISIM_NET_79),
               .Input_5(s_LOGISIM_NET_258),
               .Input_6(s_LOGISIM_NET_86),
   ...
   NOT_GATE      GATE_35 (.Input_1(s_LOGISIM_NET_29),
                          .Result(s_LOGISIM_NET_22));

   NOT_GATE      GATE_36 (.Input_1(s_LOGISIM_NET_29),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_38 (.Input_1(s_LOGISIM_NET_29),
   ...
   NOT_GATE      GATE_42 (.Input_1(s_LOGISIM_NET_29),
                          .Result(s_LOGISIM_NET_212));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_43 (.Input_1(s_LOGISIM_NET_222),
               .Input_10(s_LOGISIM_NET_241),
   ...
   NOT_GATE      GATE_45 (.Input_1(s_LOGISIM_NET_25),
   ...
   NOT_GATE      GATE_49 (.Input_1(s_LOGISIM_NET_11),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_64 (.Input_1(s_LOGISIM_NET_198),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_68 (.Input_1(s_LOGISIM_NET_7),
               .Input_2(s_LOGISIM_NET_2),
   ...
   NOT_GATE      GATE_71 (.Input_1(s_LOGISIM_NET_25),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_75 (.Input_1(s_LOGISIM_NET_194),
               .Input_2(s_LOGISIM_NET_2),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_76 (.Input_1(s_LOGISIM_NET_41),
               .Input_2(s_LOGISIM_NET_195),
               .Input_3(s_LOGISIM_NET_76),
   ...
   NOT_GATE      GATE_84 (.Input_1(s_LOGISIM_NET_13),
   ...
   NOT_GATE      GATE_88 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_180));

   NOT_GATE      GATE_89 (.Input_1(s_LOGISIM_NET_2),
                          .Result(s_LOGISIM_NET_199));

   NOT_GATE      GATE_90 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_104));

   NOT_GATE      GATE_91 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_105));

   NOT_GATE      GATE_92 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_257));

   NOT_GATE      GATE_93 (.Input_1(s_LOGISIM_NET_0),
                          .Result(s_LOGISIM_NET_44));

   NOT_GATE      GATE_94 (.Input_1(s_LOGISIM_NET_25),
   ...
   NOT_GATE      GATE_97 (.Input_1(s_LOGISIM_NET_25),
                          .Result(s_LOGISIM_NET_262));

   NOT_GATE      GATE_98 (.Input_1(s_LOGISIM_NET_24),
                          .Result(s_LOGISIM_NET_163));

   NOT_GATE      GATE_99 (.Input_1(s_LOGISIM_NET_13),
                          .Result(s_LOGISIM_NET_168));

   NOT_GATE      GATE_100 (.Input_1(s_LOGISIM_NET_7),
                           .Result(s_LOGISIM_NET_194));

   NOT_GATE      GATE_101 (.Input_1(s_LOGISIM_NET_3),
                           .Result(s_LOGISIM_NET_150));

   NOT_GATE      GATE_102 (.Input_1(s_LOGISIM_NET_11),
                           .Result(s_LOGISIM_NET_141));

   NOT_GATE      GATE_103 (.Input_1(s_LOGISIM_NET_8),
                           .Result(s_LOGISIM_NET_226));

   NOT_GATE      GATE_104 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_139));

   NOT_GATE      GATE_105 (.Input_1(s_LOGISIM_NET_2),
                           .Result(s_LOGISIM_NET_225));

   NOT_GATE      GATE_106 (.Input_1(s_LOGISIM_NET_13),
   ...
   OR_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_108 (.Input_1(s_LOGISIM_NET_126),
                ...
                .Input_7(s_LOGISIM_NET_259),
                .Input_8(s_LOGISIM_NET_178),
                .Result(s_LOGISIM_NET_161));

   NOT_GATE      GATE_109 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_101));

   NOT_GATE      GATE_110 (.Input_1(s_LOGISIM_NET_24),
   ...
   OR_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_112 (.Input_1(s_LOGISIM_NET_209),
   ...
   NOT_GATE      GATE_114 (.Input_1(s_LOGISIM_NET_11),
                           .Result(s_LOGISIM_NET_110));

   NOT_GATE      GATE_115 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_86));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_116 (.Input_1(s_LOGISIM_NET_212),
                .Input_10(s_LOGISIM_NET_58),
   ...
   NOT_GATE      GATE_119 (.Input_1(s_LOGISIM_NET_2),
   ...
   OR_GATE_7_INPUTS #(.BubblesMask(0))
      GATE_121 (.Input_1(s_LOGISIM_NET_27),
                ...
                .Input_7(s_LOGISIM_NET_229),
                .Result(s_LOGISIM_NET_253));

   NOT_GATE      GATE_122 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_67));

   NOT_GATE      GATE_123 (.Input_1(s_LOGISIM_NET_11),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_126 (.Input_1(s_LOGISIM_NET_33),
   ...
   NOT_GATE      GATE_128 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_99));

   OR_GATE_13_INPUTS #(.BubblesMask(0))
      GATE_129 (.Input_1(s_LOGISIM_NET_103),
                .Input_10(s_LOGISIM_NET_165),
                .Input_11(s_LOGISIM_NET_265),
                .Input_12(s_LOGISIM_NET_196),
                .Input_13(s_LOGISIM_NET_221),
   ...
   NOT_GATE      GATE_135 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_9));

   NOT_GATE      GATE_136 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_56));

   NOT_GATE      GATE_137 (.Input_1(s_LOGISIM_NET_3),
                           .Result(s_LOGISIM_NET_4));

   NOT_GATE      GATE_138 (.Input_1(s_LOGISIM_NET_24),
   ...
   NOT_GATE      GATE_141 (.Input_1(s_LOGISIM_NET_29),
                           .Result(s_LOGISIM_NET_222));

   NOT_GATE      GATE_142 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_201));

   NOT_GATE      GATE_143 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_238));

   NOT_GATE      GATE_144 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_47));

   NOT_GATE      GATE_145 (.Input_1(s_LOGISIM_NET_2),
                           .Result(s_LOGISIM_NET_17));

   NOT_GATE      GATE_146 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_266));

   NOT_GATE      GATE_147 (.Input_1(s_LOGISIM_NET_7),
                           .Result(s_LOGISIM_NET_62));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_148 (.Input_1(s_LOGISIM_NET_16),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_149 (.Input_1(s_LOGISIM_NET_92),
   ...
   NOT_GATE      GATE_150 (.Input_1(s_LOGISIM_NET_7),
                           .Result(s_LOGISIM_NET_186));

   NOT_GATE      GATE_151 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_63));

   NOT_GATE      GATE_152 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_54));

   NOT_GATE      GATE_153 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_28));

   NOT_GATE      GATE_154 (.Input_1(s_LOGISIM_NET_29),
   ...
   NOT_GATE      GATE_157 (.Input_1(s_LOGISIM_NET_0),
   ...
   NOT_GATE      GATE_160 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_138));

   NOT_GATE      GATE_161 (.Input_1(s_LOGISIM_NET_29),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_165 (.Input_1(s_LOGISIM_NET_7),
                .Input_2(s_LOGISIM_NET_2),
                .Input_3(s_LOGISIM_NET_25),
                .Input_4(s_LOGISIM_NET_24),
                .Input_5(s_LOGISIM_NET_3),
                .Input_6(s_LOGISIM_NET_8),
                .Input_7(s_LOGISIM_NET_72),
   ...
   NOT_GATE      GATE_168 (.Input_1(s_LOGISIM_NET_24),
   ...
   NOT_GATE      GATE_172 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_255));

   NOT_GATE      GATE_173 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_20));

   NOT_GATE      GATE_174 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_241));

   NOT_GATE      GATE_175 (.Input_1(s_LOGISIM_NET_11),
                           .Result(s_LOGISIM_NET_112));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_176 (.Input_1(s_LOGISIM_NET_29),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_179 (.Input_1(s_LOGISIM_NET_250),
                .Input_10(s_LOGISIM_NET_156),
                ...
                .Input_7(s_LOGISIM_NET_3),
                .Input_8(s_LOGISIM_NET_8),
                .Input_9(s_LOGISIM_NET_151),
                .Result(s_LOGISIM_NET_209));

   NOT_GATE      GATE_180 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_200));

   NOT_GATE      GATE_181 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_95));

   NOT_GATE      GATE_182 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_164));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_183 (.Input_1(s_LOGISIM_NET_143),
                .Input_10(s_LOGISIM_NET_230),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_184 (.Input_1(s_LOGISIM_NET_19),
                .Input_2(s_LOGISIM_NET_2),
   ...
   NOT_GATE      GATE_186 (.Input_1(s_LOGISIM_NET_11),
                           .Result(s_LOGISIM_NET_232));

   NOT_GATE      GATE_187 (.Input_1(s_LOGISIM_NET_0),
                           .Result(s_LOGISIM_NET_82));

   NOT_GATE      GATE_188 (.Input_1(s_LOGISIM_NET_29),
                           .Result(s_LOGISIM_NET_250));

   NOT_GATE      GATE_189 (.Input_1(s_LOGISIM_NET_29),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_191 (.Input_1(s_LOGISIM_NET_207),
   ...
   NOT_GATE      GATE_197 (.Input_1(s_LOGISIM_NET_2),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_201 (.Input_1(s_LOGISIM_NET_7),
                .Input_2(s_LOGISIM_NET_2),
                .Input_3(s_LOGISIM_NET_25),
   ...
   NOT_GATE      GATE_202 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_6));

   NOT_GATE      GATE_203 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_174));

   NOT_GATE      GATE_204 (.Input_1(s_LOGISIM_NET_13),
   ...
   NOT_GATE      GATE_207 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_155));

   NOT_GATE      GATE_208 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_66));

   NOT_GATE      GATE_209 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_57));

   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_210 (.Input_1(s_LOGISIM_NET_7),
   ...
   NOT_GATE      GATE_212 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_48));

   NOT_GATE      GATE_213 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_211));

   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_214 (.Input_1(s_LOGISIM_NET_7),
                .Input_2(s_LOGISIM_NET_2),
   ...
   NOT_GATE      GATE_219 (.Input_1(s_LOGISIM_NET_13),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_222 (.Input_1(s_LOGISIM_NET_59),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_223 (.Input_1(s_LOGISIM_NET_7),
                .Input_2(s_LOGISIM_NET_2),
                .Input_3(s_LOGISIM_NET_25),
   ...
   NOT_GATE      GATE_226 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_202));

   NOT_GATE      GATE_227 (.Input_1(s_LOGISIM_NET_29),
                           .Result(s_LOGISIM_NET_59));

   NOT_GATE      GATE_228 (.Input_1(s_LOGISIM_NET_7),
   ...
   NOT_GATE      GATE_231 (.Input_1(s_LOGISIM_NET_29),
                           .Result(s_LOGISIM_NET_33));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_232 (.Input_1(s_LOGISIM_NET_159),
   ...
   NOT_GATE      GATE_234 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_203));

   NOT_GATE      GATE_235 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_236));

   NOT_GATE      GATE_236 (.Input_1(s_LOGISIM_NET_24),
                           .Result(s_LOGISIM_NET_223));

   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_237 (.Input_1(s_LOGISIM_NET_23),
   ...
   NOT_GATE      GATE_238 (.Input_1(s_LOGISIM_NET_24),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_248 (.Input_1(s_LOGISIM_NET_144),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_249 (.Input_1(s_LOGISIM_NET_234),
                .Input_2(s_LOGISIM_NET_2),
   ...
   AND_GATE_8_INPUTS #(.BubblesMask(0))
      GATE_250 (.Input_1(s_LOGISIM_NET_42),
   ...
   NOT_GATE      GATE_253 (.Input_1(s_LOGISIM_NET_24),
   ...
   NOT_GATE      GATE_257 (.Input_1(s_LOGISIM_NET_25),
   ...
   AND_GATE_10_INPUTS #(.BubblesMask(0))
      GATE_259 (.Input_1(s_LOGISIM_NET_74),
   ...
   NOT_GATE      GATE_260 (.Input_1(s_LOGISIM_NET_25),
                           .Result(s_LOGISIM_NET_21));

   NOT_GATE      GATE_261 (.Input_1(s_LOGISIM_NET_11),
                           .Result(s_LOGISIM_NET_15));

   NOT_GATE      GATE_262 (.Input_1(s_LOGISIM_NET_13),
                           .Result(s_LOGISIM_NET_65));

   NOT_GATE      GATE_263 (.Input_1(s_LOGISIM_NET_25),
